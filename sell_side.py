...
while True:
        ...
        if orderbook['bids'] and orderbook['asks']:
            ...
            if (average_bid_qty - average_ask_qty > 10):
                average_ask_qty = average_ask_qty + 25
            ...
            # Instead of bidding at average price, buy it at the last order's price/ask_to_use
            # then.
            api.stock_order(venue, my_account, target_stock, bid_prices[0], \
                            50, 'buy', 'limit')
            time.sleep(3)
            api.stock_order(venue, my_account, target_stock, ask_prices[0], \
                            50, 'sell', 'limit')
            time.sleep(3)
